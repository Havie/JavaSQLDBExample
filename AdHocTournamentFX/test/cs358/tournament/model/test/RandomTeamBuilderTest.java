...
class RandomTeamBuilderTest {
  ...
  void testDropExtraParticipantsSize() {
    ...
    Assertions
        .assertTrue(pingPong.getUnattachedParticipants().contains(new Participant("Joe25", "Schmoe", "Fake place")));
    Assertions
        .assertTrue(pingPong.getUnattachedParticipants().contains(new Participant("Joe24", "Schmoe", "Fake place")));
